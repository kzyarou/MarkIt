...
const defaultTranslations: TranslationsBundle = {
  en: {
    ...
    welcome_producer: 'Connect directly with consumers and get fair prices for your harvest',
    welcome_consumer: 'Discover fresh harvests from local producers',
    ...
    search_products_placeholder: 'Search by product name, description, or farmer...',
    ...
    price_analytics_desc: 'Real-time pricing data for',
    products: 'products',
    lowest_price: 'Lowest Price',
    highest_price: 'Highest Price',
    average_price: 'Average Price',
    price_trend: 'Price Trend',
    best_deal: 'Best deal available',
    premium_quality: 'Premium quality',
    market_average: 'Market average',
    prices_increasing: 'Prices increasing',
    prices_decreasing: 'Prices decreasing',
    prices_stable: 'Prices stable',
    no_price_data: 'No Price Data',
    no_price_data_desc: 'Search for products to see real-time pricing analytics',
    category: 'Category',
    ...
    price: 'Price',
    click_to_sort_low: 'Click to sort: Low to High',
    click_to_sort_high: 'Click to sort: High to Low',
  },
  war: {
    app_name: 'MarkIt',
    ...
    // Roles
    role_producer: 'Parag-uma',
    role_consumer: 'Parapalit',
    role_admin: 'Admin',
    role_user: 'Gumaramit',
    // Home/Dashboard/MyDashboard/Create
    welcome_title: 'Welcome ha MarkIt',
    welcome_producer: 'Direkta pagkonektar ha mga parabakal para ha husto nga presyo han imo ani',
    welcome_consumer: 'Diskubrihi an presko nga ani tikang ha mga lokal nga parag-uma',
    ...
    search_products: 'Pangita hin Produkto',
    search_products_placeholder: 'Pangita pinaagi han ngaran han produkto, deskripsyon, o parag-uma...',
    ...
    no_products_found: 'Waray nakuha nga produkto',
    try_different_keywords: 'Sulayi an lain nga mga pulong.',
    try_different_search: 'Sulayi an lain nga termino ha pagpangita.',
    show_all: 'Ipakita an Ngatanan nga Produkto',
    show_all_products: 'Ipakita an Ngatanan nga Produkto',
    realtime_price: 'Real-Time nga Presyo',
    prices: 'Mga Presyo',
    market_insights: 'Mga Insight han Merkado',
    price_analytics_desc: 'Real-time nga datos han presyo para ha',
    products: 'mga produkto',
    lowest_price: 'Pinakababa nga Presyo',
    highest_price: 'Pinakataas nga Presyo',
    average_price: 'Abyer nga Presyo',
    price_trend: 'Trend han Presyo',
    best_deal: 'Pinakamaupay nga deal',
    premium_quality: 'Premium nga kalidad',
    market_average: 'Abyer han merkado',
    prices_increasing: 'Nagkakataas an presyo',
    prices_decreasing: 'Nagkakababa an presyo',
    prices_stable: 'Stable an presyo',
    no_price_data: 'Waray Data han Presyo',
    no_price_data_desc: 'Pangitaa an mga produkto basi makita an real-time nga pricing analytics',
    category: 'Kategorya',
    subcategory: 'Sub-kategorya',
    sort_by: 'I-sort pinaagi han',
    sort_price_low: 'Presyo: Ubos ngadto ha Taas',
    sort_price_high: 'Presyo: Taas ngadto ha Ubos',
    sort_newest: 'Pinakabag-o Una',
    sort_oldest: 'Pinakadaan Una',
    view: 'Kitaa',
    all_categories: 'Ngatanan nga Kategorya',
    agricultural: 'Agrikultural',
    fisheries: 'Pangingisda',
    livestock: 'Hayop',
    dairy: 'Gatas',
    poultry: 'Manok',
    all_subcategories: 'Ngatanan nga Sub-kategorya',
    newest_first: 'Pinakabag-o Una',
    price: 'Presyo',
    click_to_sort_low: 'Pinduta basi i-sort: Ubos ngadto ha Taas',
    click_to_sort_high: 'Pinduta basi i-sort: Taas ngadto ha Ubos',
  },
  tl: {
    app_name: 'MarkIt',
    settings: 'Mga Setting',
    ...
    // Roles
    role_producer: 'Magsasaka',
    role_consumer: 'Mamimili',
    role_admin: 'Admin',
    role_user: 'Gumagamit',
    // Home/Dashboard/MyDashboard/Create
    welcome_title: 'Maligayang pagdating sa MarkIt',
    welcome_producer: 'Kumonekta direkta sa mga mamimili at makakuha ng patas na presyo sa ani',
    welcome_consumer: 'Tuklasin ang mga sariwang ani mula sa lokal na magsasaka',
    ...
    search_products_placeholder: 'Maghanap ayon sa pangalan ng produkto, paglalarawan, o magsasaka...',
    ...
    no_products_found: 'Walang nakitang produkto',
    try_different_keywords: 'Subukang maghanap gamit ang ibang salita.',
    try_different_search: 'Subukang maghanap gamit ang ibang termino.',
    show_all: 'Ipakita ang Lahat ng Produkto',
    show_all_products: 'Ipakita ang Lahat ng Produkto',
    realtime_price: 'Real-Time na Presyo',
    prices: 'Mga Presyo',
    market_insights: 'Mga Insight sa Merkado',
    price_analytics_desc: 'Real-time na datos ng presyo para sa',
    products: 'mga produkto',
    lowest_price: 'Pinakamababang Presyo',
    highest_price: 'Pinakamataas na Presyo',
    average_price: 'Katamtamang Presyo',
    price_trend: 'Trend ng Presyo',
    best_deal: 'Pinakamahusay na deal',
    premium_quality: 'Premium na kalidad',
    market_average: 'Katamtaman sa merkado',
    prices_increasing: 'Tumataas ang presyo',
    prices_decreasing: 'Bumababa ang presyo',
    prices_stable: 'Matatag ang presyo',
    no_price_data: 'Walang Data ng Presyo',
    no_price_data_desc: 'Maghanap ng mga produkto para makita ang real-time na pricing analytics',
    category: 'Kategorya',
    subcategory: 'Subkategorya',
    sort_by: 'I-sort ayon sa',
    sort_price_low: 'Presyo: Mababa hanggang Mataas',
    sort_price_high: 'Presyo: Mataas hanggang Mababa',
    ...
    dairy: 'Gatas',
    poultry: 'Manok',
    all_subcategories: 'Lahat ng Subkategorya',
    newest_first: 'Pinakabago Una',
    price: 'Presyo',
    click_to_sort_low: 'I-click para i-sort: Mababa hanggang Mataas',
    click_to_sort_high: 'I-click para i-sort: Mataas hanggang Mababa',
  },
};
